...
/**
 * Remita enrolment plugin - support for user self unenrolment.
 *
...
$PAGE->set_url('/enrol/remita/unenrolself.php', array('enrolid' => $instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_remita', format_string($course->fullname));
